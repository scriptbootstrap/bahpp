...
// query table bahpp
$queryBahpp = query("SELECT * FROM tb_bahpp");
...
<head>
	...
	<title>Data Berita Acara Hasil Pemeriksaan Pekerjaan - SiKuDa BaJa</title>
...
<body>
	<div class="wrapper">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Berita Acara Hasil Pemeriksaan Pekerjaan </h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Data Berita Acara Hasil Pemeriksaan Pekerjaan
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="add-bahpp" class="btn bg-skb-3 text-white btn-round"><i class="fa fa-plus"></i> Buat BAHPP</a>
										<h4 class="card-title ml-auto"><?php echo "{$resultBAHPP["jmlhBAHPP"]}"; ?> Data BAHPP</h4>
									</div>
								</div>
								<div class="card-body">
										...
										<table id="add-row" class="display table table-striped table-hover">
											<thead>
												<tr>
													...
													<th>Jabatan</th>
													<th>Nama PPK</th>
													<th>Nama Perwakilan SM</th>
													<th>Nama Petugas Verifikasi MDP</th>
													<th>Nama Pendukung Lainnya</th>
													<th>Nama Pendukung Lainnya</th>
													<th>Jenis Surat</th>
											...
											<tbody>
												...
												<?php foreach ($queryBahpp as $row) : ?>
													<tr>
															...
															<div class="form-button-action">
																<div class="dropdown show">
																	...
																	<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																		<a class="dropdown-item text-light bg-skb-3" href="edit-bahpp?id_bahpp=<?= $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>
																		...
																		<form action="print-word" method="post">
																			...
																			<input type="text" hidden name="nama_perwakilan_sm" value="<?= $row["nama_perwakilan_sm"]; ?>">
																			<input type="text" hidden name="nama_petugas_verifikasi_mdp" value="<?= $row["nama_petugas_verifikasi_mdp"]; ?>">
																			<input type="text" hidden name="nama_pendukung1" value="<?= $row["nama_pendukung1"]; ?>">
																			<input type="text" hidden name="nama_pendukung2" value="<?= $row["nama_pendukung2"]; ?>">
																			...
																			<input type="text" hidden name="uraian" value="<?= $row["uraian"]; ?>">
																			<button type="submit" value="print" class="btn-opsi bg-skb-1"><i class="fa fa-print"></i> Cetak Word</button>
																		</form>

																		<a class="dropdown-item text-light bg-skb-6" href="#" data-toggle="modal" data-target="#delete-bahpp<?= $row["id"]; ?>"><i class=" fa fa-trash"></i> Hapus</a>
														...
														<td><?= $row["jabatan"]; ?></td>
														<td><?= $row["nama_ppk"]; ?></td>
														<td><?= $row["nama_perwakilan_sm"]; ?></td>
														<td><?= $row["nama_petugas_verifikasi_mdp"]; ?></td>
														<td><?= $row["nama_pendukung1"]; ?></td>
														<td><?= $row["nama_pendukung2"]; ?></td>
		...
		<!-- Modal Delete bahpp -->
		<?php foreach ($queryBahpp as $row) : ?>
			<div class="modal fade" id="delete-bahpp<?= $row["id"]; ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLongTitle">Hapus BAHPP?</h5>
						...
						<div class="modal-footer">
							...
							<a href="delete-bahpp?id_del_bahpp=<?= $row["id"]; ?>" type="button" class="btn bg-skb-1 text-white">Hapus</a>
						</div>
					</div>
				</div>
			</div>
