					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-form">
								<form action="bahpp" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="uraian" name="uraian" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["uraian"]; ?>">
											<label for="uraian" class="placeholder"><i class="bi bi-list-columns-reverse"></i> Uraian</label>
										</div>
									</div>
